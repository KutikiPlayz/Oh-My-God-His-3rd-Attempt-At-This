	...
	private static function onLoadJson(songJson:Dynamic) // Convert old charts to newest format
	{
		...
		for (i in 0...songJson.notes.length) { // Convert mustHitSections and gfSections to a camera event
			...
			if (section.mustHitSection != null) {
				var gfSectionDontExist = section.gfSection == null;
				var gfSectionChanged = prevSection != null && section.gfSection != prevSection.gfSection;
				var mustHitSectionChanged = prevSection != null && (!section.gfSection || gfSectionDontExist) && section.mustHitSection != prevSection.mustHitSection;
				...
				if (!gfSectionDontExist && section.gfSection) {
